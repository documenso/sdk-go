...
func newDocument(rootSDK *Documenso, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Document {
	return &Document{
		rootSDK:          rootSDK,
...
func (s *Document) DocumentGetMany(ctx context.Context, request operations.DocumentGetManyRequest, opts ...operations.Option) (*operations.DocumentGetManyResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/document/get-many")
	if err != nil {
	...
	res := &operations.DocumentGetManyResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.DocumentGetManyResponseBody
...
func (s *Document) DocumentDownload(ctx context.Context, documentID float64, version *operations.DocumentDownloadBetaVersion, opts ...operations.Option) (*operations.DocumentDownloadBetaResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/document/{documentId}/download-beta", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
