...
| `TemplateCreateDocumentFromTemplateDateFormatDdDotMmDotYyyyHHmm`       | dd.MM.yyyy HH:mm                                                       |
| `TemplateCreateDocumentFromTemplateDateFormatYyyyMMddHHmm`             | yyyy-MM-dd HH:mm                                                       |
| `TemplateCreateDocumentFromTemplateDateFormatYyMMddHhMmA`              | yy-MM-dd hh:mm a                                                       |
| `TemplateCreateDocumentFromTemplateDateFormatYyMMddHHmm`               | yy-MM-dd HH:mm                                                         |
| `TemplateCreateDocumentFromTemplateDateFormatYyyyMMddHHmmss`           | yyyy-MM-dd HH:mm:ss                                                    |
| `TemplateCreateDocumentFromTemplateDateFormatMmmmDdCommaYyyyHhMmA`     | MMMM dd, yyyy hh:mm a                                                  |
| `TemplateCreateDocumentFromTemplateDateFormatMmmmDdCommaYyyyHHmm`      | MMMM dd, yyyy HH:mm                                                    |
| `TemplateCreateDocumentFromTemplateDateFormatEeeeMmmmDdCommaYyyyHhMmA` | EEEE, MMMM dd, yyyy hh:mm a                                            |
| `TemplateCreateDocumentFromTemplateDateFormatEeeeMmmmDdCommaYyyyHHmm`  | EEEE, MMMM dd, yyyy HH:mm                                              |
| `TemplateCreateDocumentFromTemplateDateFormatIso8601Full`              | yyyy-MM-dd'T'HH:mm:ss.SSSXXX                                           |