...
<!-- UsageSnippet language="go" operationID="template-getMany" method="post" path="/template/get-many" -->
```go
package main
...
func main() {
    ...
    res, err := s.Template.TemplateGetMany(ctx, operations.TemplateGetManyRequest{
        TemplateIds: []float64{
            618.65,
            1418.73,
            1001.18,
...
**[*operations.TemplateGetManyResponse](../../models/operations/templategetmanyresponse.md), error**

### Errors

| Error Type                                   | Status Code                                  | Content Type                                 |
| -------------------------------------------- | -------------------------------------------- | -------------------------------------------- |
| apierrors.TemplateGetManyBadRequestError     | 400                                          | application/json                             |
| apierrors.TemplateGetManyUnauthorizedError   | 401                                          | application/json                             |
| apierrors.TemplateGetManyForbiddenError      | 403                                          | application/json                             |
