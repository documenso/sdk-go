...
func newEmbedding(rootSDK *Documenso, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Embedding {
	return &Embedding{
		rootSDK:          rootSDK,
...
func (s *Embedding) EmbeddingPresignCreateEmbeddingPresignToken(ctx context.Context, request operations.EmbeddingPresignCreateEmbeddingPresignTokenRequest, opts ...operations.Option) (*operations.EmbeddingPresignCreateEmbeddingPresignTokenResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/embedding/create-presign-token")
	if err != nil {
	...
	res := &operations.EmbeddingPresignCreateEmbeddingPresignTokenResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.EmbeddingPresignCreateEmbeddingPresignTokenResponseBody
...
func (s *Embedding) EmbeddingPresignVerifyEmbeddingPresignToken(ctx context.Context, request operations.EmbeddingPresignVerifyEmbeddingPresignTokenRequest, opts ...operations.Option) (*operations.EmbeddingPresignVerifyEmbeddingPresignTokenResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/embedding/verify-presign-token")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.EmbeddingPresignVerifyEmbeddingPresignTokenResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.EmbeddingPresignVerifyEmbeddingPresignTokenResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
