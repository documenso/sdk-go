...
func (r *RecipientCreateDocumentRecipientsRecipientResponse) GetExpiresAt() *string {
	if r == nil {
		return nil
	}
	return r.ExpiresAt
...
func (r *RecipientCreateDocumentRecipientsRecipientResponse) GetExpirationNotifiedAt() *string {
	if r == nil {
		return nil
	}
