...
func (s *Documents) Get(ctx context.Context, documentID float64, folderID *string, opts ...operations.Option) (*operations.DocumentGetDocumentWithDetailsByIDResponse, error) {
