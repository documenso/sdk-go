...
| `EnvelopeUpdateDateFormatDdDotMmDotYyyyHHmm`       | dd.MM.yyyy HH:mm                                   |
| `EnvelopeUpdateDateFormatYyyyMMddHHmm`             | yyyy-MM-dd HH:mm                                   |
| `EnvelopeUpdateDateFormatYyMMddHhMmA`              | yy-MM-dd hh:mm a                                   |
| `EnvelopeUpdateDateFormatYyMMddHHmm`               | yy-MM-dd HH:mm                                     |
| `EnvelopeUpdateDateFormatYyyyMMddHHmmss`           | yyyy-MM-dd HH:mm:ss                                |
| `EnvelopeUpdateDateFormatMmmmDdCommaYyyyHhMmA`     | MMMM dd, yyyy hh:mm a                              |
| `EnvelopeUpdateDateFormatMmmmDdCommaYyyyHHmm`      | MMMM dd, yyyy HH:mm                                |
| `EnvelopeUpdateDateFormatEeeeMmmmDdCommaYyyyHhMmA` | EEEE, MMMM dd, yyyy hh:mm a                        |
| `EnvelopeUpdateDateFormatEeeeMmmmDdCommaYyyyHHmm`  | EEEE, MMMM dd, yyyy HH:mm                          |
| `EnvelopeUpdateDateFormatIso8601Full`              | yyyy-MM-dd'T'HH:mm:ss.SSSXXX                       |