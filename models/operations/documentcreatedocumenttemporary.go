...
func (u *DocumentCreateDocumentTemporaryFieldUnion) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &documentCreateDocumentTemporaryFieldSignature, "", true, true); err == nil {
	...
	if err := utils.UnmarshalJSON(data, &documentCreateDocumentTemporaryFieldFreeSignature, "", true, true); err == nil {
	...
	if err := utils.UnmarshalJSON(data, &documentCreateDocumentTemporaryFieldInitials, "", true, true); err == nil {
	...
	if err := utils.UnmarshalJSON(data, &documentCreateDocumentTemporaryFieldName, "", true, true); err == nil {
	...
	if err := utils.UnmarshalJSON(data, &documentCreateDocumentTemporaryFieldEmail, "", true, true); err == nil {
	...
	if err := utils.UnmarshalJSON(data, &documentCreateDocumentTemporaryFieldDate, "", true, true); err == nil {
	...
	if err := utils.UnmarshalJSON(data, &documentCreateDocumentTemporaryFieldText, "", true, true); err == nil {
	...
	if err := utils.UnmarshalJSON(data, &documentCreateDocumentTemporaryFieldNumber, "", true, true); err == nil {
	...
	if err := utils.UnmarshalJSON(data, &documentCreateDocumentTemporaryFieldRadio, "", true, true); err == nil {
	...
	if err := utils.UnmarshalJSON(data, &documentCreateDocumentTemporaryFieldCheckbox, "", true, true); err == nil {
	...
	if err := utils.UnmarshalJSON(data, &documentCreateDocumentTemporaryFieldDropdown, "", true, true); err == nil {
