...
value := operations.TemplateCreateTemplateTemporaryDateFormatYyyyMMddHhMmA
```
...
| `TemplateCreateTemplateTemporaryDateFormatDdMmDashYyyy`             | dd-MM-yyyy                                                          |
...
| `TemplateCreateTemplateTemporaryDateFormatDdMmDashYyyyHhMmA`        | dd-MM-yyyy hh:mm a                                                  |
| `TemplateCreateTemplateTemporaryDateFormatDdMmDashYyyyHHmm`         | dd-MM-yyyy HH:mm                                                    |
