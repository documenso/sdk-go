...
| `TemplateCreateTemplateDateFormatDdDotMmDotYyyyHHmm`       | dd.MM.yyyy HH:mm                                           |
| `TemplateCreateTemplateDateFormatYyyyMMddHHmm`             | yyyy-MM-dd HH:mm                                           |
| `TemplateCreateTemplateDateFormatYyMMddHhMmA`              | yy-MM-dd hh:mm a                                           |
| `TemplateCreateTemplateDateFormatYyMMddHHmm`               | yy-MM-dd HH:mm                                             |
| `TemplateCreateTemplateDateFormatYyyyMMddHHmmss`           | yyyy-MM-dd HH:mm:ss                                        |
| `TemplateCreateTemplateDateFormatMmmmDdCommaYyyyHhMmA`     | MMMM dd, yyyy hh:mm a                                      |
| `TemplateCreateTemplateDateFormatMmmmDdCommaYyyyHHmm`      | MMMM dd, yyyy HH:mm                                        |
| `TemplateCreateTemplateDateFormatEeeeMmmmDdCommaYyyyHhMmA` | EEEE, MMMM dd, yyyy hh:mm a                                |
| `TemplateCreateTemplateDateFormatEeeeMmmmDdCommaYyyyHHmm`  | EEEE, MMMM dd, yyyy HH:mm                                  |
| `TemplateCreateTemplateDateFormatIso8601Full`              | yyyy-MM-dd'T'HH:mm:ss.SSSXXX                               |